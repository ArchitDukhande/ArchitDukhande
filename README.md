...
|--------|--------------|
| 🤖 **[Digital Twin of Archit: Evidence-Based AI System](https://github.com/ArchitDukhande/digital-twin-archit)** | Designed an evidence-grounded AI system with multi-layer retrieval and verification pipeline, enforcing zero-hallucination responses via refusal gates and quote-level validation. Focused on correctness, traceability, and safe deployment of LLM-based systems. |
